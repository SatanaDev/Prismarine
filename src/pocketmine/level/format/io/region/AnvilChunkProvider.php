...
class AnvilChunkProvider extends McRegionChunkProvider{
	...
	protected function deserializeSubChunk(CompoundTag $subChunk) : SubChunk{
		return new SubChunk(
			ChunkUtils::reorderByteArray($subChunk["Blocks"]),
			ChunkUtils::reorderNibbleArray($subChunk["Data"]),
			ChunkUtils::reorderNibbleArray($subChunk["SkyLight"], "\xff"),
			ChunkUtils::reorderNibbleArray($subChunk["BlockLight"])
		);
	}
}