...
class Level implements ChunkManager, Metadatable{
	...
	*/
	...
	public function getFullBlock(int $x, int $y, int $z) : int{
		return $this->getLoadedChunk($x >> 4, $z >> 4, false)->getFullBlock($x & 0x0f, $y, $z & 0x0f);
	}
	...
	public function getTile(Vector3 $pos){
		$chunk = $this->getLoadedChunk($pos->x >> 4, $pos->z >> 4);
	...
	public function getChunk(int $x, int $z, bool $create = false) : ?Chunk{
		if(isset($this->chunks[$index = Level::chunkHash($x, $z)])){
			...
			return $this->chunks[$index] = new Chunk($x, $z);
		}
	 ...
	 * @return bool
	 */
	public function loadChunk(int $x, int $z, bool $generate = true, ?callable $callback = null) : bool{
